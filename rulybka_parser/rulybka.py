...
from .rulybka_utils import set_city, get_product_links, parse_product

def get_all_data(shop_name):
    driver = get_browser("RULYBKA")
    all_data = []
    ...
    try:
        ...
        print(f"[{shop_name}] Критическая ошибка работы парсера.")
    finally:
        driver.quit()
...
def main(shop_name="Улыбка Радуги"):
